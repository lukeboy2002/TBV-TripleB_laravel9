<div>
    ...
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg px-4 py-2">
        <div class="flex justify-between items-center space-x-4 pb-4 max-w-7xl">
            <div class="flex items-center">
                <div class="border-l-4 border-orange-500 pl-4 flex justify-between items-center">
                    <x-links.header href="#">All Permissions</x-links.header>
                </div>
            </div>
        </div>
        <div class="flex justify-between items-center space-x-4 pb-4">
            ...
            <div>
                <x-links.btn-edit-small href="{{ route('admin.permissions.create') }}" class="rounded-lg">New permission</x-links.btn-edit-small>
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 flex justify-end space-x-4">
                        <x-links.btn-edit-small href="{{ route('admin.permissions.edit' , $permission) }}"><i class="fa-solid fa-pen-to-square"></i></x-links.btn-edit-small>
                        <x-buttons.danger-small type="button" wire:click="deleteId({{ $permission->id }})" class="rounded-lg"><i class="fa-solid fa-trash-can"></i></x-buttons.danger-small>
                    </td>
                </tr>
                @empty
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
